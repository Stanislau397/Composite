...
public class DataConstant {
    ...
    public static final String TEXT = "    It has survived - not only (five) centuries, but also the leap into electronic\n" +
            ...
            "    Bye бандерлоги.";
    public static final String TEXT_READER_RESULT = "    It has survived - not only (five) centuries, but also the leap into electronic\n" +
            "typesetting, remaining essentially unchanged. It was popularised in the “Динамо” (Рига)\n" +
            "with the release of Letraset sheets.toString() containing Lorem Ipsum passages, and\n" +
            "more recently with desktop publishing software like Aldus PageMaker Faclon9 including\n" +
            "versions of Lorem Ipsum!\n" +
            ...
            "    It is a established fact that a reader will be of a page when looking at its layout...\n" +
            "    Bye бандерлоги.";
    public static final String LONGEST_WORD_IN_TEXT = "The point of using Ipsum is that it has a\n" +
            "more-or-less normal distribution ob.toString(a?b:c), as opposed to using (Content here),\n" +
            "content here's, making it look like readable English?";
    public static final String SENTENCE_WITH_WORDS_LESS_THAN_GIVEN = "Bye бандерлоги.";
    public static final String DUPLICATE_WORDS = "reader = 2\n" +
            "when = 2\n" +
            "lorem = 2\n" +
            "that = 3\n" +
            "has = 2\n" +
